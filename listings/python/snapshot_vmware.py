...
inputs = {'vcenter_ip': 'IP/name',
          'vcenter_password': 'pass',
          'vcenter_user': 'usert',
          'vm_name': ['ep-tt-m-001','ep-tt-m-002','ep-tt-m-003','ep-tt-m-004','ep-tt-m-005','ep-tt-e-001','ep-tt-e-002','ep-tt-e-003','ep-tt-e-004','ep-tt-e-005','ep-tt-i-001','ep-tt-i-002','ep-tt-i-003','ep-tt-w-001','ep-tt-w-002','ep-tt-w-003'],
          # operation in 'create/remove/revert/
          # list_all/list_current/remove_all'
          'operation': 'list_all',
          'snapshot_name': 'pre_deploy_21_03',
          'ignore_ssl': True
          }
